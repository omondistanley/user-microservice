...
# Optional AI explainer for recommendation narratives (OpenRouter, generic, Groq, Brave)
...
AI_EXPLAINER_PROVIDER_ORDER: str = os.environ.get("AI_EXPLAINER_PROVIDER_ORDER", "openrouter,groq,brave,generic")
# OpenRouter (OpenAI-compatible chat endpoint)
OPENROUTER_API_BASE: str = os.environ.get("OPENROUTER_API_BASE", "https://openrouter.ai/api/v1").rstrip("/")
OPENROUTER_API_KEY: str = os.environ.get("OPENROUTER_API_KEY", "")
OPENROUTER_MODEL: str = os.environ.get("OPENROUTER_MODEL", "")
OPENROUTER_TIMEOUT_SECONDS: int = int(os.environ.get("OPENROUTER_TIMEOUT_SECONDS", "10"))
OPENROUTER_HTTP_REFERER: str = os.environ.get("OPENROUTER_HTTP_REFERER", "").strip()
OPENROUTER_X_TITLE: str = os.environ.get("OPENROUTER_X_TITLE", "pocketii").strip()
