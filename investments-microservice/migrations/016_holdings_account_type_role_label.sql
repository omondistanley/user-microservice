...
COMMENT ON COLUMN holding.account_type IS 'taxable | traditional_ira | roth_ira | 401k | hsa | other';
COMMENT ON COLUMN holding.role_label   IS 'core | growth | income | hedge | speculative | null (unclassified)';
